...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
        GetDataFromInternet.AsyncResponse {
    ...
    public void proccessFinish(String output) {
        ...
        try {
            ...
            String dateString = formatter.format(new Date(Long.parseLong(timeSunrise)
                    * 1000 + (60 * 60 * 1000) * 5));
            ...
            dateString = formatter.format(new Date(Long.parseLong(timeSunset) * 1000
                    + (60 * 60 * 1000) * 5));
